...
import { ShuffledTranslations } from "../api/translations";
...
class RateEpsilonTokens extends React.Component {
    ...
    handleClickButton(key, value) {
        ...
        Meteor.call('translations.answers.update', currentSentence._id, key, value);
    }
...
export default withTracker(() => {
    const subscription = Meteor.subscribe('translations.shuffled');
    const isLoading = !subscription.ready();

    const translations = ShuffledTranslations.find({ _id: "nH4crNQFXKpo7yWhF" }).fetch();
